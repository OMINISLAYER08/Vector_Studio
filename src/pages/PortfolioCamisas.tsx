        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h1 className="font-display text-3xl md:text-5xl font-bold mt-4 mb-6">
              <span className="text-gradient-gold">Portfólio</span> de Camisas
            </h1>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Aqui estarão todas as estampas e designs exclusivos para vestuário. Em breve!
            </p>
          </div>
          {/* Placeholder for shirts grid */}
